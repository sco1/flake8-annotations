...
formatting_test_cases = {
    "arg": FormatTestCase(
        ...
        repr_output=(
            "Argument(argname='test_arg', lineno=0, col_offset=0, annotation_type=AnnotationType.ARGS, "  # noqa: E501
    ...
    "func_no_args": FormatTestCase(
        ...
        repr_output=(
            "Function(name='test_func', lineno=0, col_offset=0, function_type=FunctionType.PUBLIC, "
            "is_class_method=False, class_decorator_type=None, is_return_annotated=False, "
            "has_type_comment=False, has_only_none_returns=True, "
